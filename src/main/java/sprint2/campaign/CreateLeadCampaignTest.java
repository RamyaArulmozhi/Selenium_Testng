...
public class CreateLeadCampaignTest extends CampaignTest {
	...
	@Test
	public void createLeadCampaign() throws InterruptedException
	{
		clickCampaign();
		...
		WebElement salutationField = driver.findElement(By.xpath("//div[@class='salutation compoundTLRadius compoundTRRadius compoundBorderBottom form-element__row uiMenu']//a"));
		...
		driver.findElement(By.xpath("//span[text()='Company']/parent::label/following-sibling::input")).sendKeys("TestLeaf");
		...
		List<WebElement> rowSearch = driver.findElements(By.xpath("//table[@class='slds-table slds-table_header-fixed slds-table_bordered slds-table_edit slds-table_resizable-cols']/tbody/tr/th//a"));
